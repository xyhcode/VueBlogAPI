...
func init() {
	...
	givemoneyMixin := schema.GiveMoney{}.Mixin()
	givemoneyMixinHooks0 := givemoneyMixin[0].Hooks()
	givemoney.Hooks[0] = givemoneyMixinHooks0[0]
	givemoneyFields := schema.GiveMoney{}.Fields()
	_ = givemoneyFields
	// givemoneyDescCreatedAt is the schema descriptor for created_at field.
	givemoneyDescCreatedAt := givemoneyFields[1].Descriptor()
	// givemoney.DefaultCreatedAt holds the default value on creation for the created_at field.
	givemoney.DefaultCreatedAt = givemoneyDescCreatedAt.Default.(func() time.Time)
	// givemoneyDescUpdatedAt is the schema descriptor for updated_at field.
	givemoneyDescUpdatedAt := givemoneyFields[2].Descriptor()
	// givemoney.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	givemoney.DefaultUpdatedAt = givemoneyDescUpdatedAt.Default.(func() time.Time)
	// givemoney.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	givemoney.UpdateDefaultUpdatedAt = givemoneyDescUpdatedAt.UpdateDefault.(func() time.Time)
	// givemoneyDescNickname is the schema descriptor for nickname field.
	givemoneyDescNickname := givemoneyFields[3].Descriptor()
	// givemoney.NicknameValidator is a validator for the "nickname" field. It is called by the builders before save.
	givemoney.NicknameValidator = func() func(string) error {
		validators := givemoneyDescNickname.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
