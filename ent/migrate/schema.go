...
var (
	...
	// GiveMoneysColumns holds the columns for the "give_moneys" table.
	GiveMoneysColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint, Increment: true, Comment: "主键ID"},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true},
		{Name: "created_at", Type: field.TypeTime, Comment: "创建时间"},
		{Name: "updated_at", Type: field.TypeTime, Comment: "更新时间"},
		{Name: "nickname", Type: field.TypeString, Size: 50, Comment: "昵称"},
		{Name: "figure", Type: field.TypeInt, Comment: "金额"},
	}
	// GiveMoneysTable holds the schema information for the "give_moneys" table.
	GiveMoneysTable = &schema.Table{
		Name:       "give_moneys",
		Comment:    "打赏记录表",
		Columns:    GiveMoneysColumns,
		PrimaryKey: []*schema.Column{GiveMoneysColumns[0]},
	}
