...
func (sq *SubscriberQuery) FirstIDX(ctx context.Context) int {
...
func (sq *SubscriberQuery) OnlyIDX(ctx context.Context) int {
...
func (sq *SubscriberQuery) IDs(ctx context.Context) (ids []int, err error) {
